package com.mobile.android.chameapps.timebaskets.screens.categories.ui.imagepicker.provider

import android.Manifest
import android.app.Activity
import android.content.Intent
import androidx.core.app.ActivityCompat.requestPermissions
import com.mobile.android.chameapps.timebaskets.screens.categories.ui.imagepicker.util.FileUriUtils
import com.mobile.android.chameapps.timebaskets.screens.categories.ui.imagepicker.ImagePickerActivity
import com.mobile.android.chameapps.timebaskets.screens.categories.ui.imagepicker.util.IntentUtils
import com.mobile.android.chameapps.timebaskets.screens.categories.ui.imagepicker.util.PermissionUtil
import java.io.File
    ...
    fun onRequestPermissionsResult(requestCode: Int) {
        if (requestCode == PERMISSION_INTENT_REQ_CODE) {
            ...
            if (PermissionUtil.isPermissionGranted(
                ...
                setError("permission_gallery_denied")
            }
        }
    }
    ...
    private fun handleResult(data: Intent?) {
        ...
        if (uri != null) {
            ...
            if (!filePath.isNullOrEmpty()) {
                ...
                setError("error_failed_pick_gallery_image")
            }
        } else {
            setError("error_failed_pick_gallery_image")
        }
