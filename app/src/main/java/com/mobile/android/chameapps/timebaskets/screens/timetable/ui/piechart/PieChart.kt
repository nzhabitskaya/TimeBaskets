package com.mobile.android.chameapps.timebaskets.screens.timetable.ui.piechart
...
class PieChart : FrameLayout {
    ...
    fun init() {
        ...
        palette[3] = Color.parseColor("#EEFFE87C") // yellow
        palette[4] = Color.parseColor("#EE0090BD") // blue
    }
