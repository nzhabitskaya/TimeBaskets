...
import com.mobile.android.chameapps.timebaskets.screens.adddialog.imagepicker.listener.ResultListener
import com.mobile.android.chameapps.timebaskets.screens.adddialog.imagepicker.util.DialogHelper
import java.io.File
                ...
                object :
                    ...
                    override fun onResult(t: ImageProvider?) {
                        if (t != null) {
                            ...
                            val intent =
                                ImagePickerActivity.getCancelledIntent(
                                    activity
                                )
